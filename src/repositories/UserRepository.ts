...
class UserRepository {
    ...
    // ================================================================================
    public createUserR({userName, userEmail, userCPF, userPhone, userPassword}: createUser) : User {
        const usuario = new User({userName, userEmail, userCPF, userPhone, userPassword});
